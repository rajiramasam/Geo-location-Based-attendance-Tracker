...
function SignupFormDemo() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 md:shadow-[0px_2px_0px_2px_#00f7d6_inset,0px_-2px_0px_-2px_#00f7d6_inset] shadow-input bg-black dark:bg-black md:mt-16 mt-8  ">
